...
const createRepeatedBookingDay = (data, body) => {
  return new Promise(async (resolve, reject) => {
    ...
    try {
      while (
        ...
        dayToCheck = addDays(dayToCheck, body.details.repeatOptions.interval);
      }
...
export default createRepeatedBookingDay;
